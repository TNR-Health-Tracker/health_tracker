...
class FoodEntriesControllerTest < ActionController::TestCase
  ...
  test "should create food_entry" do
    assert_difference('FoodEntry.count') do
      post :create, food_entry: { calories: @food_entry.calories, entry_date: @food_entry.entry_date, name: @food_entry.name }
    end
  ...
  test "should update food_entry" do
    patch :update, id: @food_entry, food_entry: { calories: @food_entry.calories, entry_date: @food_entry.entry_date, name: @food_entry.name }
    assert_redirected_to food_entry_path(assigns(:food_entry))
  end
