...
class ExercisesControllerTest < ActionController::TestCase
  ...
  test "should create exercise" do
    assert_difference('Exercise.count') do
      post :create, exercise: { entry_date: @exercise.entry_date - 2.days, exercise_type_id: 1 }
    end
  ...
  test "should update exercise" do
    patch :update, id: @exercise, exercise: { entry_date: @exercise.entry_date, exercise_type_id: @exercise.exercise_type_id,
